...
class FilterModel: ObservableObject {
    ...
    @Published var filterState: FilterState = {
        ...
        guard let data = UserDefaults(suiteName: "group.io.cbot.swift-paperless")!.object(forKey: "GlobalFilterState") as? Data else {
            print("No default")
            return FilterState()
        }
        do {
        ...
        didSet {
            ...
            UserDefaults(suiteName: "group.io.cbot.swift-paperless")!.set(s, forKey: "GlobalFilterState")
